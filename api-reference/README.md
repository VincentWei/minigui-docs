# MiniGUI API Reference Manuals

The API reference manuals are always consistent with the source code and are
released with the source code packages at the same time.
