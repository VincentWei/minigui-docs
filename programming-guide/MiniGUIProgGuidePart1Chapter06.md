...
First, we call CreateMenu to create an empty menu, and then call InsertMenuItem
...
is related to uFlags argument. UFlags argument can take the following values:

- TPM_LEFTALIGN: Menu is horizontally left aligned based on (x, y) point, that
