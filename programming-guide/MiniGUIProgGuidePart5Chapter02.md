...
<center>     <img src="%ATTACHURLPATH%/17.1.jpeg" alt="17.1.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 17.1 Taskbar created by mginit in mg-samples</center>
...
<center>List 17.1 The code of a simple mginit program</center>
```cplusplus
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
```
This program sets the OnNewDelClient event handling function of mginit. It will set the global variable quit as TRUE when the event handling function encounter LCO_DEL_CLIENT, so as to result in the stop of the message loop, and finally exits the server.
