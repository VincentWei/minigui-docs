...
<center>Table 13.1 Basic drawing attributes and operation function</center>
<center>  
...
<center>List 13.1 Loading and showing a bitmap</center>
```cplusplus
 case MSG_CREATE:
...
<center>     <img src="%ATTACHURLPATH%/13.1.jpeg" alt="13.1.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig 13.1 Loading and showing a bitmap</center>
...
The program in List 13.2 first fills in a round shape then uses BitBlt to copy it and fill out whole client area. The complete code of this program can be seen from program bitblt.c included in mg-samples program package.

<center>List 13.2 Using BitBlt function</center>
```cplusplus
...
<center>     <img src="%ATTACHURLPATH%/13.2.jpeg" alt="13.2.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 13.2  Presentation of BitBlt operation</center>
...
<center>List 13.3 Using StretchBlt function</center>
```cplusplus
#include <minigui/common.h>
#include <minigui/minigui.h>
#include <minigui/gdi.h>
...
<center>     <img src="%ATTACHURLPATH%/13.3.jpeg" alt="13.3.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 13.3 The presentation of StretchBlt operation</center>
