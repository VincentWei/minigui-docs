...
guide. Some common styles are listed in Table 3.1. The identifiers for
these styles are defined in minigui/window.h, with prefix of WS_ or WS_EX.
...
##### Figure 5 A multi-line EditBox control which background color is red</center>
...
MSG_MOUSEMOVE, MSG_KEYDOWN, and MSG_CHAR etc. Messages posted into message
...
for the main windows or controls, as shown in Table 3.2. In this guide, we
