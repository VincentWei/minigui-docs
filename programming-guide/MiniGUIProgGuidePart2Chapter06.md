...
%CODE{cpp}%
%INCLUDE{"%ATTACHURL%/checkbutton.c.txt" pattern="^.*?//
...
%CODE{cpp}%
%INCLUDE{"%ATTACHURL%/colorbutton.c.txt" pattern="^.*?//
...
[Next](MStudioMGNCSV1dot0PGENP2C4][Previous]] <
[[MStudioMGNCSV1dot0PGEN][Index]] > [[MStudioMGNCSV1dot0PGENP2C6)
