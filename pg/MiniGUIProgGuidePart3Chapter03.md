...
New GDI function boosts up the memory DC operation function. GDI function will call GAL-related interface while setting memory DC as it will fully use the hardware acceleration of video adapter to quickly move or copy the bit blocks between different regions, including transparence processing and alpha blending. Application can create a memory DC with the property that each point has different alpha value. Also, application can create the alpha value (alpha channel of the DC) of all pixels of memory DC by using SetMemDCAlpha, then use BitBlt and StretchBlt to transfer the bits between DCs. Application also can set the transparent pixel of a source DC, so as to leap over such pixel while performing BitBlt.
...
CreateMemDCFromMyBitmap create a memory DC which point to device unrelative bitmap.
...
<center>List 15.1 The enhanced memory DC operations</center>
```cplusplus
...
<center>List 15.2 The enhanced BITMAP operations</center>
```cplusplus
int tox = 800, toy = 800;
    int count;
    BITMAP bitmap;
...
<center>     <img src="%ATTACHURLPATH%/15.1_T.jpeg" alt="15.1_T.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.1 Polygons</center>
...
<center>     <img src="%ATTACHURLPATH%/15.2.jpeg" alt="15.2.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.2 The output effect of special regions</center>
...
## 15.12 Advanced Two-Dimension GDI Functions
...
### 15.12.1 Pen and Its Properties
...
<center>     <img src="%ATTACHURLPATH%/15.3.jpeg" alt="15.3.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.3 Pen types</center>
...
<center>     <img src="%ATTACHURLPATH%/15.4.jpeg" alt="15,4.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.4 Cap styles of pen</center>
...
<center>     <img src="%ATTACHURLPATH%/15.5.jpeg" alt="15.5.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.5  The join styles of pen</center>

Table 15.1 gives the operations on pen properties.
<center>Table 15.1 Operating functions on pen properties</center>
<center>
|*Function*                           |*Purpose*|
...
<center>     <img src="%ATTACHURLPATH%/15.6.jpeg" alt="15.6.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.6 Dash lines</center>
...
### 15.12.2 Brush and Its Properties
...
- BT_OPAQUE_STIPPLED: The opaque stipple bitmap brush drawing by using the stipple bitmap. Pixels corresponding to bits in the stipple bitmap that are set will be drawn in the brush color; pixels corresponding to bits that are not set will be drawn with the background color.
...
### 15.12.3 Advanced Two-Dimension Drawing Functions
...
### 15.12.4 Using Advanced Two-Dimension GDI Functions
The code in List 15.5 uses the above advanced two-dimension GDI function to draw some graphics objects. Fig. 15.7 gives the output effect of this code.

<center>List 15.5 Using advanced two-dimension GDI functions</center>
```cplusplus
#ifdef _ADV_2DAPI
...
<center>     <img src="%ATTACHURLPATH%/15.7.jpeg" alt="15.7.jpeg"  ALIGN="CENTER" /> </center>
<center>Fig. 15.7 The output of advanced two-dimension GDI functions</center>

## 15.13 Support for Slave Screens
...
### 15.13.1 Creating Slave Screen
The following function can used to open the slave screen:

```cplusplus
HDC GUIAPI InitSlaveScreen (const char *name, cnost char *mode);
```
InitSlaveScreen return a graphics device context handle by a special device name and display mode. name specifies what map engine the slave screen uses, and mode specifies the resolution and color depth of the slave screen. The following code is a example for opening a slave screen.
...
### 15.13.2 Destroying Slave Screen
