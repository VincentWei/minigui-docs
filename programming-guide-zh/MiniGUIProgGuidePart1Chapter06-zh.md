...
__清单 1.1__ 给出了普通菜单的编程实例，该实例是 `mg-samples` 中 `notebook` 的一部分，鉴于篇幅，只给出关于菜单的部分。该程序创建的菜单效果见__图 1.1__。

__清单 1.1__ 普通菜单的编程实例
...
__图 1.1__ 记事本程序创建的菜单

__清单 1.2__ 给出了弹出式菜单的编程实例。

__清单 1.2__ 弹出菜单的编程实例
...
__清单 1.2__ 中的程序创建的弹出式菜单如__图 1.2__ 所示。
